...
public class AstarRefactor implements Algorithm {
    ...
    public AstarRefactor(Intruder player) {
    ...
    public class AStarNode {
        ...
        private final AstarRefactor aStarGoal;


        public AStarNode(XY xy, AstarRefactor aStarGoal) {
            this.coordinate = xy;
            this.parent = null;
